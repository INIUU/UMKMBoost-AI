...
export default function Login({ status, canResetPassword, canRegister, error }: LoginProps) {
  return (
    <AuthLayout
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  {canResetPassword && (
                    <TextLink href={request()} className="text-xs text-gray-500 hover:text-sky-600" tabIndex={5}>
                      Lupa password?
                    </TextLink>
                  )}
                </div>
...
/>
            ...
            {canRegister && (
              <p className="text-center text-sm text-gray-600">
                Belum punya akun?{" "}
                <TextLink href={register()} tabIndex={5} className="text-sky-600 hover:text-sky-700 font-semibold">
                  Daftar sekarang
                </TextLink>
              </p>
            )}
